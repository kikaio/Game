...
constexpr LoginData::LoginData(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : device_key_(&::PROTOBUF_NAMESPACE_ID::internal::fixed_address_empty_string)
  , login_platform_(0){}
...
static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_UserAndGameServer_2eproto[16];
...
const uint32_t TableStruct_UserAndGameServer_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::UserAndGameServer::UserProfile, profile_id_),
  PROTOBUF_FIELD_OFFSET(::UserAndGameServer::UserProfile, account_lv_),
  PROTOBUF_FIELD_OFFSET(::UserAndGameServer::UserProfile, nick_name_),
  PROTOBUF_FIELD_OFFSET(::UserAndGameServer::UserProfile, greeting_ment_),
  PROTOBUF_FIELD_OFFSET(::UserAndGameServer::UserProfile, profile_hero_id_),
  PROTOBUF_FIELD_OFFSET(::UserAndGameServer::UserProfile, profile_frame_id_),
  PROTOBUF_FIELD_OFFSET(::UserAndGameServer::UserProfile, main_hero_id_),
  ~0u,  // no _has_bits_
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::UserAndGameServer::LoginData, device_key_),
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::UserAndGameServer::UserProfile)},
  { 13, -1, -1, sizeof(::UserAndGameServer::ChatProfile)},
  { 24, -1, -1, sizeof(::UserAndGameServer::ChatData)},
...
const char descriptor_table_protodef_UserAndGameServer_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "rver\"\250\001\n\013UserProfile\022\022\n\nprofile_id\030\001 \001(\005"
  "\022\022\n\naccount_lv\030\002 \001(\005\022\021\n\tnick_name\030\003 \001(\t\022"
  "\025\n\rgreeting_ment\030\004 \001(\t\022\027\n\017profile_hero_i"
  "d\030\005 \001(\005\022\030\n\020profile_frame_id\030\006 \001(\005\022\024\n\014mai"
  "n_hero_id\030\007 \001(\005\"}\n\013ChatProfile\022\022\n\nprofil"
  "e_id\030\001 \001(\005\022\021\n\tnick_name\030\002 \001(\t\022\027\n\017profile"
  "_hero_id\030\003 \001(\005\022\030\n\020profile_frame_id\030\004 \001(\005"
  "\022\024\n\014main_hero_id\030\005 \001(\005\"`\n\010ChatData\022\021\n\tch"
  "at_type\030\001 \001(\005\0224\n\014chat_profile\030\002 \001(\0132\036.Us"
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 16)) {
          account_lv_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 34)) {
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "UserAndGameServer.UserProfile.greeting_ment"));
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* UserProfile::_InternalSerialize(
  ...
  // int32 account_lv = 2;
  if (this->_internal_account_lv() != 0) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32ToArray(2, this->_internal_account_lv(), target);
  }
  ...
  if (!this->_internal_greeting_ment().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "UserAndGameServer.UserProfile.greeting_ment");
    target = stream->WriteStringMaybeAliased(
        4, this->_internal_greeting_ment(), target);
  }

  // int32 profile_hero_id = 5;
  if (this->_internal_profile_hero_id() != 0) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32ToArray(5, this->_internal_profile_hero_id(), target);
  }

  // int32 profile_frame_id = 6;
  if (this->_internal_profile_frame_id() != 0) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32ToArray(6, this->_internal_profile_frame_id(), target);
  }

  // int32 main_hero_id = 7;
  if (this->_internal_main_hero_id() != 0) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32ToArray(7, this->_internal_main_hero_id(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:UserAndGameServer.UserProfile)
  ...
  // int32 account_lv = 2;
  if (this->_internal_account_lv() != 0) {
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::Int32SizePlusOne(this->_internal_account_lv());
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:UserAndGameServer.UserProfile)
  ...
  if (from._internal_account_lv() != 0) {
    _internal_set_account_lv(from._internal_account_lv());
  }
...
void UserProfile::InternalSwap(UserProfile* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(UserProfile, main_hero_id_)
      + sizeof(UserProfile::main_hero_id_)
      - PROTOBUF_FIELD_OFFSET(UserProfile, profile_id_)>(
...
LoginData::LoginData(const LoginData& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  device_key_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    device_key_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), "", GetArenaForAllocation());
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (!from._internal_device_key().empty()) {
    device_key_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, from._internal_device_key(), 
      GetArenaForAllocation());
  }
...
inline void LoginData::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
  device_key_.DestroyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          auto str = _internal_mutable_device_key();
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "UserAndGameServer.LoginData.device_key"));
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* LoginData::_InternalSerialize(
  ...
  // string device_key = 1;
  if (!this->_internal_device_key().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      this->_internal_device_key().data(), static_cast<int>(this->_internal_device_key().length()),
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "UserAndGameServer.LoginData.device_key");
    target = stream->WriteStringMaybeAliased(
        1, this->_internal_device_key(), target);
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:UserAndGameServer.LoginData)
  ...
  if (!from._internal_device_key().empty()) {
    _internal_set_device_key(from._internal_device_key());
  }
...
void LoginData::InternalSwap(LoginData* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      &device_key_, lhs_arena,
      &other->device_key_, rhs_arena
  );
...
class AnsLogin::_Internal {
 public:
  ...
  static const ::UserAndGameServer::UserProfile& user_profile(const AnsLogin* msg);
};
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    ...
    0, static_cast<size_t>(reinterpret_cast<char*>(&user_profile_) -
    reinterpret_cast<char*>(&login_result_data_)) + sizeof(user_profile_));
}
...
void AnsLogin::InternalSwap(AnsLogin* other) {
  ...
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(AnsLogin, user_profile_)
      + sizeof(AnsLogin::user_profile_)
