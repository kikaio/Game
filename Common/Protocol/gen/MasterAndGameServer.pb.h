...
inline int32_t NotiErrInfo::err_detail() const {
  // @@protoc_insertion_point(field_get:MasterAndGameServer.NotiErrInfo.err_detail)
...
inline void NotiErrInfo::set_err_detail(int32_t value) {
  ...
  // @@protoc_insertion_point(field_set:MasterAndGameServer.NotiErrInfo.err_detail)
}
