...
PROTOBUF_NAMESPACE_OPEN
template<> ::MasterAndGameServer::AnsConnect* Arena::CreateMaybeMessage<::MasterAndGameServer::AnsConnect>(Arena*);
template<> ::MasterAndGameServer::NotiErrInfo* Arena::CreateMaybeMessage<::MasterAndGameServer::NotiErrInfo>(Arena*);
template<> ::MasterAndGameServer::ReqConnect* Arena::CreateMaybeMessage<::MasterAndGameServer::ReqConnect>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace MasterAndGameServer {
...
constexpr Protocol Protocol_MAX = Connect;
...
class ReqConnect final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:MasterAndGameServer.ReqConnect) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "MasterAndGameServer.ReqConnect";
  }
  protected:
  ...
  enum : int {
    ...
    kServerInstanceNoFieldNumber = 1,
  };
  ...
  void clear_server_instance_no();
  int32_t server_instance_no() const;
  void set_server_instance_no(int32_t value);
  private:
  int32_t _internal_server_instance_no() const;
  void _internal_set_server_instance_no(int32_t value);
  public:

  // @@protoc_insertion_point(class_scope:MasterAndGameServer.ReqConnect)
 private:
  class _Internal;
...
class AnsConnect final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:MasterAndGameServer.AnsConnect) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "MasterAndGameServer.AnsConnect";
  }
  protected:
  ...
  // @@protoc_insertion_point(class_scope:MasterAndGameServer.AnsConnect)
 private:
  class _Internal;
...
// int32 server_instance_no = 1;
inline void ReqConnect::clear_server_instance_no() {
  server_instance_no_ = 0;
}
inline int32_t ReqConnect::_internal_server_instance_no() const {
  return server_instance_no_;
}
inline int32_t ReqConnect::server_instance_no() const {
  // @@protoc_insertion_point(field_get:MasterAndGameServer.ReqConnect.server_instance_no)
  return _internal_server_instance_no();
}
inline void ReqConnect::_internal_set_server_instance_no(int32_t value) {
  
  server_instance_no_ = value;
}
inline void ReqConnect::set_server_instance_no(int32_t value) {
  _internal_set_server_instance_no(value);
  // @@protoc_insertion_point(field_set:MasterAndGameServer.ReqConnect.server_instance_no)
}

// string server_name = 2;
inline void ReqConnect::clear_server_name() {
  server_name_.ClearToEmpty();
}
inline const std::string& ReqConnect::server_name() const {
  // @@protoc_insertion_point(field_get:MasterAndGameServer.ReqConnect.server_name)
  return _internal_server_name();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void ReqConnect::set_server_name(ArgT0&& arg0, ArgT... args) {
 ...
 server_name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:MasterAndGameServer.ReqConnect.server_name)
}
inline std::string* ReqConnect::mutable_server_name() {
  std::string* _s = _internal_mutable_server_name();
  // @@protoc_insertion_point(field_mutable:MasterAndGameServer.ReqConnect.server_name)
  return _s;
}
inline const std::string& ReqConnect::_internal_server_name() const {
  return server_name_.Get();
}
inline void ReqConnect::_internal_set_server_name(const std::string& value) {
  
  server_name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* ReqConnect::_internal_mutable_server_name() {
  
  return server_name_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* ReqConnect::release_server_name() {
  // @@protoc_insertion_point(field_release:MasterAndGameServer.ReqConnect.server_name)
  return server_name_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
inline void ReqConnect::set_allocated_server_name(std::string* server_name) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:MasterAndGameServer.ReqConnect.server_name)
}
...
// bool success = 1;
inline void AnsConnect::clear_success() {
  success_ = false;
}
inline bool AnsConnect::_internal_success() const {
  return success_;
}
inline bool AnsConnect::success() const {
  // @@protoc_insertion_point(field_get:MasterAndGameServer.AnsConnect.success)
  return _internal_success();
}
inline void AnsConnect::_internal_set_success(bool value) {
  
  success_ = value;
}
inline void AnsConnect::set_success(bool value) {
  _internal_set_success(value);
  // @@protoc_insertion_point(field_set:MasterAndGameServer.AnsConnect.success)
}
