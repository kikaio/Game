...
#define ENUM_TO_INT(_eType) magic_enum::enum_inteager(_eType)

#define ENUM_TO_STR(_eType) magic_enum::enum_name(_eType)

#define ENUM_NAMES(_eClass) magic_enum::enum_names<_eClass>()

#define ENUM_FROM_STR(_eClass, _str) magic_enum::enum_cast<_eClass>(_eStr, magic_enum::case_insensitive)
