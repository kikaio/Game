...
ET EnumFromStr(string _val) {
	return magic_enum::enum_cast<ET>(_val, magic_enum::case_insensitive);
}
...
template<typename ET>
ET EnumFromInt(int32_t _val) {
	return magic_enum::enum_cast<ET>(_val);
}
