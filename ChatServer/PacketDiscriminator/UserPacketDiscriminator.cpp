...
void UserPacketDiscriminator::Init()
{
	...
	REGIST_USER_CLIENT_PACKET_HANDLE(Req, EnterChatRoom);
}
...
IMPL_MAKE_SENDBUF_USER_CLIENT_PACKET(Noti, EnterChatRoom);
IMPL_MAKE_SENDBUF_USER_CLIENT_PACKET(Noti, LeaveChatRoom);
